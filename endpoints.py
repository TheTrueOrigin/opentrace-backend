...
def get_product(product_id):
    ...
    return {
        ...
        "Nährwerte": {
            "Brennwert": result_product[8],
            "Fettgehalt": result_product[9],
            "Gesättigte_Fettsäuren": result_product[10],
            "Kohlenhydrate": result_product[11],
            "Zuckergehalt": result_product[12],
